...
int Number_Of_Days_Between_Dates(int, int, int, int);
    ...
    /* Note * 12/15/20
     * I should probably use a structure for this project...
    */ 
...
int main(int argc, char** argv) {
    ...
    // The following code can be thrown into a method
    //-----------------------------------------------------------------------------------------------------------------------------------------
    // For months with 31 Days
    if (first_month == 1 ||first_month == 3 ||first_month == 5 ||first_month == 7 ||first_month == 8 ||first_month == 10 ||first_month == 12) 
    {
        cout << "Enter Day (1-31): ";
        cin >> day_one;
        
        // input validation to make sure day is between 1 and 31.
    ...
    // Lastly, get year for first date entered.
    cout << "Enter Year: ";
    cin >> year_one;
    //-----------------------------------------------------------------------------------------------------------------------------------------

    
    // Now, time to get user input for Date 2
    //
